  ...
  <div id="product">
        ...
        <section class="row m0 between-xs">
          ...
          <div class="col-xs-12 col-md-5 data">
            ...
            <p class="shortdescription">
              <span v-if="getCurrentProduct.short_description">{{
                getCurrentProduct.short_description | strippedContent
              }}</span>
            </p>
            ...
            <div>
              ...
              <related-variant
                type="related"
                :linkedproducts="getCurrentProduct.linkedproducts"
    ...
    <div class="row hotcoldp40">
      <div class="col-xs-12 flex center-xs middle-xs">
        <img
          class="hotclode visible-xs"
          src="assets/hotcoldsafe2.jpg"
          height="198"
        />
        <img
          class="hotclode hidden-xs"
          src="assets/hotcoldsafe.jpg"
          height="198"
        />
      </div>
    </div>
...
export default {
  ...
  mixins: [ProductOption, fbqViewContent],
  ...
  methods: {
    ...
    getProductPrimaryCategory() {
      if (
        ...
        Array.isArray(this.getCurrentProduct.category) &&
        this.getCurrentProduct.category.length > 0
      ) {
        return this.getCurrentProduct.category[
          this.getCurrentProduct.category.length - 1
        ];
      }
      return false;
    },
      ...
      meta: [
        ...
        },
        {
          ...
          content:
            htmlDecode(
              this.getCurrentProduct.meta_title || this.getCurrentProduct.name
            ) + " - W10 Collapsible Cup and Eco-Friendly Drinkware",
        },
        ...
        {
          property: "og:url",
          content: "https://w10.world/" + this.$route.path,
        },
        {
          property: "og:image",
          content:
            "https://w10.world/img/0/0/resize/catalog/product/" +
            this.getCurrentProduct.image,
        },
